...
class AdduserDialog(QDialog, Ui_FormInterface):
    ...
    def add_item_to_list_of_users(self, row, col, item: QTableWidgetItem):
    ...
    def test_add(self):
        rowPosition = self.table_widget_list_of_users.rowCount()
        print(rowPosition)
        self.table_widget_list_of_users.insertRow(rowPosition)
        self.table_widget_list_of_users.setItem(rowPosition, 0, QTableWidgetItem("text2"))
        self.table_widget_list_of_users.setItem(rowPosition, 2, QTableWidgetItem("text3"))
