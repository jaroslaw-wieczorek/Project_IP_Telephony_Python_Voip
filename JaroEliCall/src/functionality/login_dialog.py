...
class LoginDialog(LoginWrappedUI):
    ...
    def getLoggingStatus(self):
        ...
        elif self.client.received == "403 NOT ACCEPTABLE" or self.client.received == "409 NOT ACCEPTABLE":
    ...
    def clickOnLoginButton(self):
        ...
        if self.validateData:
            print("[*] LoginDialog info: " +
                  "The validateData method returned True")

            # print("[*] Answer loggingToServer ")
            # print(self.loggingToServer(self.get_login(),
            #                            self.get_password()))

            if self.loggingToServer(self.get_login(), self.get_password()):
                print("[*] LoginDialog info: The loggingToServer " +
                      "method returned True")

                self.loggingSignal.emit(True, self.get_login())
                # self.loggedSignal.emit({"abc": 123}, name="loggedSignal")
                print("[*] LoginDialog info: The loggingSignal " +
            ...
            print("[*] LoginDialog error: The validateData " +
                  "method returned False")
    ...
    def clickOnRegisterButton(self):
        ...
        print("[*] LoginDialog info: The registerAccountSignal " +
              "was emitted with True")
